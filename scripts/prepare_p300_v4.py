#!/usr/bin/env python
"""
Prepare BNCI2014-009 (P300 speller) with 128 pipeline variants.

Auto-downloads via MOABB. Binary: Target(1) vs Non-target(0).
10 subjects, 16 channels, 1s epochs.
"""
...
def main(args):
    out_dir = Path(args.output_dir) / "p300"
    ...
    for subj in dataset.subject_list:
        ...
        for config in configs:
            ...
            # a4: baseline (200ms = 51 samples at 256Hz)
